...
- We further validate the efficacy of our data construction on other foundation models such as Baichuan2. The deployable model checkpoints can be found [here](https://github.com/ChiyuSONG/data-efficient-training-of-LLMs). :grin:**Have Fun!**
